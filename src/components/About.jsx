...
export default function About() {
  ...
  return (
    <div className="min-h-screen h-auto border-x-black flex flex-col p-5 md:pr-0 h-min-[100vh]" id="About Me">
      <div>
      ...
      <div className="w-full flex md:flex-row flex-col h-full m-auto">
        ...
        <div className="md:w-1/3 w-full flex flex-col md:p-0 p-5">
          <div className="md:w-1/2 rounded-full overflow-hidden m-auto min-w-28 md:max-w-60 max-w-40 w-auto">
            <img
              src={pfp}
              alt="Profile_Picture"
